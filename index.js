...
const smoothScrool = function (target) {
...
promotion.addEventListener("click", smoothScrool(promotionSection));

const products = document.querySelector("#products");
const productsSection = document.querySelector(".products");

products.addEventListener("click", smoothScrool(productsSection));

const services = document.querySelector("#services");
const servicesSection = document.querySelector(".services");

services.addEventListener("click", smoothScrool(servicesSection));

const contacts = document.querySelector("#contact");
const contactsSection = document.querySelector(".contact");

contacts.addEventListener("click", smoothScrool(contactsSection));

const team = document.querySelector("#team");
const teamSection = document.querySelector(".team");

team.addEventListener("click", smoothScrool(teamSection));
